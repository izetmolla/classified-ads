    			...
    			<div class="row">
    								...
    								<div class="row ">
    									<div class="col-6  ">
    										<a class="app-icon" target="_blank"  href="https://itunes.apple.com/">
    											...
    											<img src="<?php echo getmainurl(); ?>assets/img/app_store_badge.svg" alt="Available on the App Store">
    										</a>
    									</div>
    									<div class="col-6  ">
    										<a class="app-icon"  target="_blank" href="https://play.google.com/store/">
    											<span class="hide-visually">Android App</span>
    											<img src="<?php echo getmainurl(); ?>assets/img/google-play-badge.svg" alt="Available on the App Store">
    										</a>
    									</div>
    								</div>
    							</div>
    				...
    				<div class="col-xl-12">
    					<div class=" text-center paymanet-method-logo">
    						...
    						<img src="<?php echo getmainurl(); ?>assets/img/master_card.png" alt="img">
    						<img alt="img" src="<?php echo getmainurl(); ?>assets/img/visa_card.png">
    						<img alt="img" src="<?php echo getmainurl(); ?>assets/img/paypal.png">
    						<img alt="img" src="<?php echo getmainurl(); ?>assets/img/american_express_card.png"> <img alt="img" src="<?php echo getmainurl(); ?>assets/img/discover_network_card.png">
    						<img alt="img" src="<?php echo getmainurl(); ?>assets/img/google_wallet.png">
    					</div>

    					<div class="copy-info text-center">
    						&copy; 2017 <?php echo getPageOpt('header_title'); ?>. All Rights Reserved.
    					</div>
...
<!-- /.wrapper -->
<script src="<?php echo getmainurl(); ?>assets/js/jquery/jquery-3.3.1.min.js"></script>
<script>window.jQuery || document.write('<script src="<?php echo getmainurl(); ?>assets/js/jquery/jquery-3.3.1.min.js">\x3C/script>')</script>

<script src="<?php echo getmainurl(); ?>assets/js/vendors.min.js"></script>

<!-- include custom script for site  -->
<script src="<?php echo getmainurl(); ?>assets/js/main.min.js"></script>
